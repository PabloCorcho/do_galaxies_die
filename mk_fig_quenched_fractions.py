...
fig, axs = plt.subplots(ncols=3, nrows=3, figsize=(6,6), sharex=True, sharey=True,
...
for ith, data_i in enumerate(data_sets_names.keys()):
    ...
    H, xbins, ybins = np.histogram2d(np.log10(M), np.log10(sSFR),
...
ax.legend(handles=legend_elements, loc=(-0.95, 1.1), ncol=2, framealpha=1, edgecolor='k')                
